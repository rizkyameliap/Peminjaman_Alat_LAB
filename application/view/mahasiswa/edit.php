            ...
            <div class="card-body">
                ...
                <?= form_open('mahasiswa/edit/'.$mahasiswa->id) ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="program_studi" id="program_studi" class="form-control" value="<?= $mahasiswa->program_studi ?>" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="telepon" id="telepon" class="form-control" value="<?= $mahasiswa->telepon ?>" required>
                    </div>
                    <div class="form-group">
